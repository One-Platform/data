...
public interface UserRepository extends JpaRepository<User, Integer>, JpaSpecificationExecutor<User>,
	...
	/**
	 * Redeclaration of {@link org.springframework.data.repository.CrudRepository#findOne(java.io.Serializable)} to change transaction configuration.
	 */
	@Transactional
	...
	/**
	 * Method to directly create query from and adding a {@link org.springframework.data.domain.Pageable} parameter to be regarded on query execution.
	 * 
	 * @param pageable
	 * @param lastname
	 * @return
	...
	/**
	 * Method to directly create query from and adding a {@link org.springframework.data.domain.Pageable} parameter to be regarded on query execution.
	 * Just returns the queried {@link org.springframework.data.domain.Page}'s contents.
	 * 
	 * @param firstname
	 * @param pageable
	 * @return
	...
	/**
	 * Manipulating query to set all {@link org.springframework.data.jpa.domain.sample.User}'s names to the given one.
	 * 
	 * @param lastname
	 */
	@Modifying
