 ...
 */
public class OneSimpleJpaRepositoryConfiguration extends
		RepositoryConfig<OneSimpleJpaRepositoryConfiguration.JpaRepositoryConfiguration, OneSimpleJpaRepositoryConfiguration> {

	private static final String FACTORY_CLASS = "com.sinosoft.one.data.jpa.repository.support.OneJpaRepositoryFactoryBean";
	private static final String ENTITY_MANAGER_FACTORY_REF = "entity-manager-factory-ref";

	/**
	 * @param repositoriesElement
	 */
	public OneSimpleJpaRepositoryConfiguration(Element repositoriesElement) {
	...
	private static class AutomaticJpaRepositoryConfigInformation extends
			AutomaticRepositoryConfigInformation<OneSimpleJpaRepositoryConfiguration> implements JpaRepositoryConfiguration {

		public AutomaticJpaRepositoryConfigInformation(String interfaceName, OneSimpleJpaRepositoryConfiguration parent) {
	...
	private static class ManualJpaRepositoryConfigInformation extends
			ManualRepositoryConfigInformation<OneSimpleJpaRepositoryConfiguration> implements JpaRepositoryConfiguration {

		public ManualJpaRepositoryConfigInformation(Element element, OneSimpleJpaRepositoryConfiguration parent) {
