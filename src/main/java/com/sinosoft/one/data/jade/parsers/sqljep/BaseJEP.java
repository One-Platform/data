...
import com.sinosoft.one.data.jade.parsers.sqljep.function.Declare;
...
public abstract class BaseJEP implements ParserVisitor {
	...
	*/
	 ...
	 * @throws com.sinosoft.one.data.jade.parsers.sqljep.ParseException
	 */
	 ...
	 * @throws com.sinosoft.one.data.jade.parsers.sqljep.ParseException If there are errors in the expression then it fires the exception
	 */
	final public void parseExpression(Map<String,Integer> columnMapping,Map<String,Variable> variableMapping,final Map<String,PostfixCommand> funMap) throws ParseException {
		...
		try {
			...
			throw new com.sinosoft.one.data.jade.parsers.sqljep.ParseException(toString(), e);
		}
		
		if (hasError()) {
			throw new com.sinosoft.one.data.jade.parsers.sqljep.ParseException(getErrorInfo());
		}
	 ...
	 * {@link com.sinosoft.one.data.jade.parsers.sqljep.JepRuntime#stack} for evaluation.
	 * <p>
