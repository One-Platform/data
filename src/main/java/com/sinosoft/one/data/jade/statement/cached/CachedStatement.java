 ...
 */
package com.sinosoft.one.data.jade.statement.cached;

import com.sinosoft.one.data.jade.annotation.Cache;
import com.sinosoft.one.data.jade.annotation.CacheDelete;
import com.sinosoft.one.data.jade.annotation.SQLType;
import com.sinosoft.one.data.jade.statement.Statement;
...
/**
 * {@link com.sinosoft.one.data.jade.statement.cached.CachedStatement} 封装了支持Cache的逻辑
 * 
 * @author qieqie.wang
 * 
 */
