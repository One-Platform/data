...
public final class OracleDateFormat extends OracleTimestampFormat {
	...
	public OracleDateFormat(String pattern) throws ParseException {
	...
	public OracleDateFormat(String pattern, Calendar calendar, DateFormatSymbols dateSymb) throws ParseException {
		cal = calendar;
		symb = dateSymb;
		format = formatsCache.get(pattern);
		if (format == null) {
