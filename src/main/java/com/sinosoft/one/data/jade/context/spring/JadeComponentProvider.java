...
/**
 * {@link com.sinosoft.one.data.jade.context.spring.JadeComponentProvider}用于查找一个目录或jar包下符合Jade规范的DAO接口。
 * 
 * @author Mark Fisher
 ...
 * 
 * @see com.sinosoft.one.data.jade.context.spring.JadeComponentProvider
...
public class JadeComponentProvider implements ResourceLoaderAware {
     ...
     * {@link org.springframework.beans.factory.config.BeanDefinition#getBeanClassName()} 得到对应的DAO接口的类名
     * <p>
