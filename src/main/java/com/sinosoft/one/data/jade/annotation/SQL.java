 ...
 */
package com.sinosoft.one.data.jade.annotation;
...
/**
 * 用{@link com.sinosoft.one.data.jade.annotation.SQL}注解标注在Jade DAO方法上，表示这个DAO方法所要执行的SQL语句。
 * <p>
 * 
 ...
 * 比如SHOW语句所代表的就应该是查询类型的，在这种情况下，我们还是希望由开发者您在{@link com.sinosoft.one.data.jade.annotation.SQL}
 ...
 * <p>
 * 在此，我们也示例了{@link com.sinosoft.one.data.jade.annotation.SQL}注解所使用语句和标准的SQL的有所区别。为了更加有效地支持编程，此处的SQL具有较为丰富的法，具体请见：
